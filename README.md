...
部署目標為 Vercel，並透過 GitHub Actions 部署。Next.js Route Handlers 會在 server-side 讀取 `FINMIND_API_TOKEN` 並代理 FinMind API。
...
- push 到 `main`：通過檢查後使用 Vercel CLI 部署 production。
